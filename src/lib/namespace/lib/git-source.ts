...
import { INamespaceEventName, INamespaceSource, INamespaceSourceGitConfig } from "../interfaces";
...
export class NamespaceSourceGit extends EventEmitter implements INamespaceSource {
    ...
    constructor (
        ...
        private readonly _config: INamespaceSourceGitConfig,
