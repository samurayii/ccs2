import { IKeyStoreEventName, IKeyStoreSource, IKeyStoreSourceGitConfig } from "../interfaces";
...
export class KeyStoreSourceGit extends EventEmitter implements IKeyStoreSource {
    ...
    constructor (
        ...
        private readonly _config: IKeyStoreSourceGitConfig,
    ...
    private async _sync (): Promise<void> {
        ...
        if ((await promiseFsExists(this._full_tmp_folder_path)) === false) {
            ...
            try {
                ...
                this._logger.debug(`Repository ${chalk.cyan(this._server_str)} cloned`);
